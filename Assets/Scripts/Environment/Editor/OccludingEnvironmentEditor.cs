...
public class OccludingEnvironmentEditor : MonoBehaviour
{
	[MenuItem("NIIT/Setup Occluding Environment Object")]
	static void Setup()
	{
		...
		active.layer = LayerMask.NameToLayer("OccludingEnvironment");
	...
	[MenuItem("NIIT/Remove Occluding Environment Object")]
	static void Remove()
	{
		GameObject active = Selection.activeGameObject;
		OccludingEnvironment occludingEnvironment;
